...
namespace Language_ru {
  ...
  LSTR  MSG_DISABLE_STEPPERS                = _UxGT("Выкл. моторы");
 ...
 LSTR  MSG_AUTO_Z_ALIGN                    = _UxGT("Авто Z-выравнивание");
  ...
  LSTR  MSG_LEVEL_BED_HOMING                = _UxGT("Парковка стола");
  ...
  LSTR  MSG_Z_FADE_HEIGHT                   = _UxGT("Z затухания коррекции");
  #if LCD_WIDTH > 21 || HAS_DWIN_E3V2
  ...
  LSTR  MSG_SELECT_ORIGIN                   = _UxGT("Выберите ноль");
  ...
  #endif
  #if HAS_PREHEAT
    LSTR  MSG_PREHEAT_1                     = _UxGT("Нагреть для  ") PREHEAT_1_LABEL;
    ...
    LSTR  MSG_PREHEAT_M                     = _UxGT("Нагреть для $");
  ...
  #endif
  LSTR  MSG_PREHEAT_CUSTOM                  = _UxGT("Разогреть");
  ...
  LSTR  MSG_PROBING_MESH                    = _UxGT("Точка сетки");
  ...
  LSTR  MSG_IDEX_MODE_AUTOPARK              = _UxGT("Автопарковка");
  ...
  LSTR  MSG_AUTOTEMP                        = _UxGT("Автотемп. под поток");
  ...
  LSTR  MSG_PID_BAD_EXTRUDER_NUM            = _UxGT("Сбой подбора! Не тот экструдер.");
  LSTR  MSG_PID_TEMP_TOO_HIGH               = _UxGT("Сбой подбора! Перегрев.");
  LSTR  MSG_PID_TIMEOUT                     = _UxGT("Сбой подбора! Долго.");
  ...
  LSTR  MSG_MOTION                          = _UxGT("Перемещения");
  LSTR  MSG_FILAMENT                        = _UxGT("Пруток");
  LSTR  MSG_VOLUMETRIC_ENABLED              = _UxGT("E в мм3") SUPERSCRIPT_THREE;
  LSTR  MSG_VOLUMETRIC_LIMIT                = _UxGT("E огран.,мм3") SUPERSCRIPT_THREE;
  LSTR  MSG_VOLUMETRIC_LIMIT_E              = _UxGT("E огран. *");
  #if LCD_WIDTH > 21 || HAS_DWIN_E3V2
    LSTR  MSG_FILAMENT_DIAM                 = _UxGT("Диам. прутка");
    LSTR  MSG_FILAMENT_DIAM_E               = _UxGT("Диам. прутка *");
  #else
    LSTR  MSG_FILAMENT_DIAM                 = _UxGT("Диам. прутка");
    LSTR  MSG_FILAMENT_DIAM_E               = _UxGT("Диам. прутка *");
  #endif
  ...
  LSTR  MSG_TUNE                            = _UxGT("Поднастроить");
  ...
  LSTR  MSG_CANCEL_OBJECT                   = _UxGT("Отменить объект");
  LSTR  MSG_CANCEL_OBJECT_N                 = _UxGT("Отменить объект =");
  LSTR  MSG_OUTAGE_RECOVERY                 = _UxGT("Прод.печати после откл.");
  ...
  LSTR  MSG_STOPPED                         = _UxGT("ОСТАНОВЛЕНО. ");
    ...
    LSTR  MSG_CONTROL_RETRACT_SWAP          = _UxGT("Откат замены., мм");
    LSTR  MSG_CONTROL_RETRACT_RECOVER_SWAP  = _UxGT("Доп.возврат замены, мм");
    LSTR  MSG_CONTROL_RETRACT_RECOVER_SWAPF = _UxGT("Возврат замены, мм/с");
    LSTR  MSG_AUTORETRACT                   = _UxGT("Автооткат");
  #else
    LSTR  MSG_CONTROL_RETRACT               = _UxGT("Откат, мм");
    LSTR  MSG_CONTROL_RETRACT_SWAP          = _UxGT("Откат замены");
    LSTR  MSG_CONTROL_RETRACT_RECOVER_SWAP  = _UxGT("Доп.возв замены");
    LSTR  MSG_CONTROL_RETRACT_RECOVER_SWAPF = _UxGT("Возврат замен,V");
    LSTR  MSG_AUTORETRACT                   = _UxGT("Автооткат");
  #endif
  LSTR  MSG_CONTROL_RETRACT_ZHOP            = _UxGT("Прыжок Z, мм");
  LSTR  MSG_CONTROL_RETRACTF                = _UxGT("Скор. отката");
  LSTR  MSG_CONTROL_RETRACT_RECOVER         = _UxGT("Доп.возврат, мм");
  LSTR  MSG_CONTROL_RETRACT_RECOVERF        = _UxGT("Скор. возврата");

  LSTR  MSG_FILAMENT_SWAP_LENGTH            = _UxGT("Длина смены");
  #if LCD_WIDTH > 21 || HAS_DWIN_E3V2
    LSTR  MSG_FILAMENT_SWAP_EXTRA           = _UxGT("Доп.длина смены");
  #else
    LSTR  MSG_FILAMENT_SWAP_EXTRA           = _UxGT("Доп.длина смены");
  #endif
  LSTR  MSG_FILAMENT_PURGE_LENGTH           = _UxGT("Длина очистки");
  ...
  LSTR  MSG_SINGLENOZZLE_UNRETRACT_SPEED    = _UxGT("Скорость наката");
  LSTR  MSG_SINGLENOZZLE_FAN_SPEED          = _UxGT("Обороты вент.");
  LSTR  MSG_SINGLENOZZLE_FAN_TIME           = _UxGT("Время вент.");
  ...
  LSTR  MSG_FILAMENTCHANGE                  = _UxGT("Смена прутка");
  LSTR  MSG_FILAMENTCHANGE_E                = _UxGT("Смена прутка *");
  LSTR  MSG_FILAMENTLOAD                    = _UxGT("Загрузить пруток");
  LSTR  MSG_FILAMENTUNLOAD                  = _UxGT("Выгрузить пруток");
  #if LCD_WIDTH > 21 || HAS_DWIN_E3V2
    LSTR  MSG_FILAMENTLOAD_E                = _UxGT("Загрузить пруток *");
    LSTR  MSG_FILAMENTUNLOAD_E              = _UxGT("Выгрузить пруток *");
  #else
  ...
  #if LCD_WIDTH > 21 || HAS_DWIN_E3V2
    LSTR  MSG_MESH_DONE                     = _UxGT("Сетка построена");
  #else
    LSTR  MSG_MESH_DONE                     = _UxGT("Сетка построена");
  #endif

  LSTR  MSG_INFO_STATS_MENU                 = _UxGT("Статистика");
  ...
  LSTR  MSG_KILL_EXPECTED_PRINTER           = _UxGT("Неверный принтер");
    ...
    LSTR  MSG_INFO_PRINT_LONGEST            = _UxGT("Наидольшая");
    LSTR  MSG_INFO_PRINT_FILAMENT           = _UxGT("Выдавлено");
  #endif
  LSTR  MSG_INFO_COMPLETED_PRINTS           = _UxGT("Завершенных");
  ...
  LSTR  MSG_FILAMENT_CHANGE_HEADER          = _UxGT("ЗАМЕНА ПРУТКА");
  ...
  #if LCD_WIDTH > 21 || HAS_DWIN_E3V2
    LSTR  MSG_RUNOUT_SENSOR                 = _UxGT("Датчик прутка");
  #else
    LSTR  MSG_RUNOUT_SENSOR                 = _UxGT("Датчик прутка");
  #endif
  ...
  LSTR  MSG_MMU2_CHOOSE_FILAMENT_HEADER     = _UxGT("ВЫБИРЕТЕ ПРУТОК");
  ...
  LSTR  MSG_PAUSE_PRINT_PARKING             = _UxGT(MSG_1_LINE("Парковка..."));
    ...
    LSTR  MSG_FILAMENT_CHANGE_INIT          = _UxGT(MSG_2_LINE("Ожидайте начала", "смены прутка"));
    LSTR  MSG_FILAMENT_CHANGE_INSERT        = _UxGT(MSG_3_LINE("Вставьте пруток", "и нажмите кнопку", "для продолжения"));
    ...
    LSTR  MSG_FILAMENT_CHANGE_UNLOAD        = _UxGT(MSG_3_LINE("Ожидайте", "выгрузки", "прутка"));
    LSTR  MSG_FILAMENT_CHANGE_LOAD          = _UxGT(MSG_3_LINE("Ожидайте", "загрузки", "прутка"));
    LSTR  MSG_FILAMENT_CHANGE_PURGE         = _UxGT(MSG_3_LINE("Ожидайте", "экструзии", "прутка"));
    LSTR  MSG_FILAMENT_CHANGE_CONT_PURGE    = _UxGT(MSG_3_LINE("Нажмите кнопку", "для завершения", "прочистки сопла"));
